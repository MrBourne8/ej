...
if (isset($_POST['submit'])) {
    $sql = ("INSERT INTO `pm_01_241`(`student_name`, `sem_3`, `sem_4`, `sem_5`, `sem_6`, `sem_7`, `ekz`, `final`) VALUES(?,?,?,?,?,?,?,?)");
...
// Read
$sql = $pdo->prepare("SELECT * FROM `pm_01_241`");
$sql->execute();
...
if (isset($_POST['edit-submit'])) {
    $sqll = "UPDATE pm_01_241 SET sem_3=?, sem_4=?, sem_5=?, sem_6=?, sem_7=?, ekz=?, final=? WHERE id=?";
...
if (isset($_POST['delete_submit_mat_401'])) {
    $sql = "DELETE FROM pm_01_241 WHERE id=?";
    $query = $pdo->prepare($sql);
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page__title">ПМ 01 241 группа
                    <br>
                    ...
                    <tbody>
                        <?php foreach ($result_mat_401 as $value) { ?>
                            <tr>
                                ...
                                <!-- <td class="sem_3 ">
                                    <p class="mark_mat_401"><?= $value['sem_3'] ?></p>
                                </td> -->
                                <td class="sem_4 ">
                                        ...
                                        <div class="modal-body">
                                            <form action="?id=<?= $value['id'] ?>" id="?id=<?= $value['id'] ?>" method="post">
                                                ...
                                                <!-- <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_sem_3_401 mark__mat__401" name="edit_sem_3" value="<?= $value['sem_3'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 3 семестр">
                                                </div>
                                                <hr> -->
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_sem_4_401 edit__mark__mat__401" name="edit_sem_4" value="<?= $value['sem_4'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 4 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_sem_5_401 edit__mark__mat__401" name="edit_sem_5" type="number" value="<?= $value['sem_5'] ?>" step="1" placeholder="0" min="2" max="5" title="Отметка за 5 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_sem_6_401 edit__mark__mat__401" name="edit_sem_6" value="<?= $value['sem_6'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 6 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_sem_7_401 edit__mark__mat__401" name="edit_sem_7" value="<?= $value['sem_7'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 7 семестр">
                                                </div>
                                                <hr>
                                                <!-- <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_exam_401 edit__mark__mat__401" name="edit_ekz" value="<?= $value['ekz'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за экзамен">
                                                </div> -->
                                                <input type="text" class="edit__final__mark__mat__401" name="edit__final__mark__mat__401" value="" hidden>
