...
if (isset($_POST['submit'])) {
    $sql = ("INSERT INTO `pm05411`(`student_name`, `sem_3`, `sem_4`, `sem_5`, `sem_6`, `sem_7`, `ekz`, `final`) VALUES(?,?,?,?,?,?,?,?)");
...
// Read
$sql = $pdo->prepare("SELECT * FROM `pm05411`");
$sql->execute();
...
if (isset($_POST['edit-submit'])) {
    $sqll = "UPDATE pm05411 SET sem_3=?, sem_4=?, sem_5=?, sem_6=?, sem_7=?, ekz=?, final=? WHERE id=?";
...
if (isset($_POST['delete_submit_pm03_341'])) {
    $sql = "DELETE FROM pm05411 WHERE id=?";
    $query = $pdo->prepare($sql);
                                        ...
                                        <div class="modal-body">
                                            <form action="?id=<?= $value['id'] ?>" id="?id=<?= $value['id'] ?>" method="post">
                                                ...
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_sem_6_341 edit__mark__pm03__341" name="edit_sem_6" value="<?= $value['sem_6'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 6 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_sem_7_341 edit__mark__pm03__341" name="edit_sem_7" value="<?= $value['sem_7'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 7 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_exam_341 edit__mark__pm03__341" name="edit_ekz" value="<?= $value['ekz'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за экзамен">
                                                </div>
                                                <input type="text" class="edit__final__mark__pm03__341" name="edit__final__mark__pm03__341" value="" hidden>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Отмена</button>
                                                    <button type="submit" name="edit-submit" class="btn btn-primary edit__student__final edit__student__final__341__pm03">Обновить</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                        ...
                        <form action="" method="post">
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" class="final__mark__pm03__341 form__final__mark" name="final__mark__pm03__341" value="" hidden>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Отмена</button>
