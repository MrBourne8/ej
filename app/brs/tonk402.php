...
if (isset($_POST['submit'])) {
    $sql = ("INSERT INTO `tonk402`(`student_name`, `sem_3`, `sem_4`, `sem_5`, `sem_6`, `sem_7`, `ekz`, `final`) VALUES(?,?,?,?,?,?,?,?)");
...
// Read
$sql = $pdo->prepare("SELECT * FROM `tonk402`");
$sql->execute();
...
if (isset($_POST['edit-submit'])) {
    $sqll = "UPDATE tonk402 SET sem_3=?, sem_4=?, sem_5=?, sem_6=?, sem_7=?, ekz=?, final=? WHERE id=?";
...
if (isset($_POST['delete_submit_pm03_341'])) {
    $sql = "DELETE FROM tonk402 WHERE id=?";
    $query = $pdo->prepare($sql);
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page__title">Теоретические основы начального курса математики 402 группа
                    <br>
