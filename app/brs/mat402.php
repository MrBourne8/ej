...
$sem_7 = $_POST['sem_7'];
$ekz = $_POST['ekz'];
$final = $_POST['final__mark__mat__402'];

$get_id = $_GET['id'];

// Create
if (isset($_POST['submit'])) {
    $sql = ("INSERT INTO `mat402`(`student_name`, `sem_3`, `sem_4`, `sem_5`, `sem_6`, `sem_7`, `ekz`, `final`) VALUES(?,?,?,?,?,?,?,?)");
...
// Read
$sql = $pdo->prepare("SELECT * FROM `mat402`");
$sql->execute();
$result_mat_402 = $sql->fetchAll();
// Read
...
$edit_final = $_POST['edit__final__mark__mat__402'];


if (isset($_POST['edit-submit'])) {
    $sqll = "UPDATE mat402 SET sem_3=?, sem_4=?, sem_5=?, sem_6=?, sem_7=?, ekz=?, final=? WHERE id=?";
...
// DELETE
if (isset($_POST['delete_submit_mat_402'])) {
    $sql = "DELETE FROM mat402 WHERE id=?";
    $query = $pdo->prepare($sql);
...
<head>
    <meta charset="UTF-8">
    <title>Теоретические основы начального курса математики с методикой преподавания 402 группа</title>
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page__title">Теоретические основы начального курса математики с методикой преподавания 402 группа
                    <br>
                ...
                <table class="table shadow mehtod_mat_402 table__modules" style="border-collapse: collapse;">
                    ...
                    <tbody>
                        <?php foreach ($result_mat_402 as $value) { ?>
                            <tr>
                                ...
                                <td class="sem_3 ">
                                    <p class="mark_mat_402"><?= $value['sem_3'] ?></p>
                                </td>
                                <td class="sem_4 ">
                                    <p class="mark_rus_402"><?= $value['sem_4'] ?></p>
                                </td>
                                <td class="sem_5">
                                    <p class="mark_rus_402"><?= $value['sem_5'] ?></p>
                                </td>
                                <td class="sem_6">
                                    <p class="mark_rus_402"><?= $value['sem_6'] ?></p>
                                </td>
                                <td class="sem_7">
                                    <p class="mark_rus_402"><?= $value['sem_7'] ?></p>
                                </td>
                                <td class="ekz">
                                    <p class="mark_rus_402"><?= $value['ekz'] ?></p>
                                </td>
                                <td>
                                    <p class="final_rus_402 final__mark"><?= $value['final'] ?></p>
                                </td>
                                        ...
                                        <div class="modal-body">
                                            <form action="?id=<?= $value['id'] ?>" id="?id=<?= $value['id'] ?>" method="post">
                                                ...
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_sem_3_402 mark__mat__402" name="edit_sem_3" value="<?= $value['sem_3'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 3 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_sem_4_402 edit__mark__mat__402" name="edit_sem_4" value="<?= $value['sem_4'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 4 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_sem_5_402 edit__mark__mat__402" name="edit_sem_5" type="number" value="<?= $value['sem_5'] ?>" step="1" placeholder="0" min="2" max="5" title="Отметка за 5 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_sem_6_402 edit__mark__mat__402" name="edit_sem_6" value="<?= $value['sem_6'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 6 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_sem_7_402 edit__mark__mat__402" name="edit_sem_7" value="<?= $value['sem_7'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 7 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_exam_402 edit__mark__mat__402" name="edit_ekz" value="<?= $value['ekz'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за экзамен">
                                                </div>
                                                <input type="text" class="edit__final__mark__mat__402" name="edit__final__mark__mat__402" value="" hidden>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Отмена</button>
                                                    <button type="submit" name="edit-submit" class="btn btn-primary edit__student__final edit__student__final__402">Обновить</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-content shadow">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="?id=<?= $value['id'] ?>" method="post">
                                                <button type="submit" name="delete_submit_mat_402" class="btn btn-danger brs__delete">Удалить</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <form action="" method="post">
                            <div class="form-group add__student__brs">
                                ...
                                <select class="select__students__final__mark select__mat" name="student_name" id="add_student_brs331">
                                    <?php foreach ($result_base_402 as $value) { ?>
                            ...
                            <div class="form-group edit__brs">
                                ...
                                <input class="form-control sem__3__mat__402 semestr__mark" id="average__current_1" name="sem_3" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                            ...
                            <div class="form-group edit__brs">
                                ...
                                <input class="form-control sem__4__mat__402 semestr__mark" id="average__current_1" name="sem_4" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                            </div>
                            <hr>
                            <div>
                                <div class="form-group edit__brs">
                                    ...
                                    <input class="form-control sem__5__mat__402 semestr__mark" id="average__current_1" name="sem_5" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                    <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                                </div>
                                <hr>
                                <div>
                                    <div class="form-group edit__brs">
                                        ...
                                        <input class="form-control sem__6__mat__402 semestr__mark" id="average__current_1" name="sem_6" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                        <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                                    </div>
                                    <hr>
                                    <div class="form-group edit__brs">
                                        ...
                                        <input class="form-control sem__7__mat__402 semestr__mark" id="average__current_1" name="sem_7" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                        <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                                    </div>
                                    <hr>
                                    <div class="form-group edit__brs">
                                        ...
                                        <input class="form-control ekz__mat__402 exam__mark" id="average__current_1" name="ekz" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                        <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                                    </div>
                                    <hr>

                                    <input type="text" class="final__mark__mat__402 form__final__mark" name="final__mark__mat__402" value="" hidden>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Отмена</button>
