...
if (isset($_POST['submit'])) {
    $sql = ("INSERT INTO `pm04_421`(`student_name`, `sem_5`, `sem_6`, `sem_7`, `sem_8`, `up`, `pp`, `test`, `otv`, `ekz`, `final`) VALUES(?,?,?,?,?,?,?,?,?,?,?)");
...
// Read
$sql = $pdo->prepare("SELECT * FROM `pm04_421`");
$sql->execute();
...
if (isset($_POST['edit-submit'])) {
    $sqll = "UPDATE pm04_421 SET sem_5=?, sem_6=?, sem_7=?, sem_8=?, up=?, pp=?, test=?, otv=?, ekz=?, final=? WHERE id=?";
...
if (isset($_POST['delete_submit_pm03_341'])) {
    $sql = "DELETE FROM pm04_421 WHERE id=?";
    $query = $pdo->prepare($sql);
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page__title">ПМ04 421 группа
                    <br>
