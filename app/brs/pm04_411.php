...
if (isset($_POST['submit'])) {
    $sql = ("INSERT INTO `mat401`(`student_name`, `sem_3`, `sem_4`, `sem_5`, `sem_6`, `sem_7`, `ekz`, `final`) VALUES(?,?,?,?,?,?,?,?)");
...
// Read
$sql = $pdo->prepare("SELECT * FROM `mat401`");
$sql->execute();
...
if (isset($_POST['edit-submit'])) {
    $sqll = "UPDATE mat401 SET sem_3=?, sem_4=?, sem_5=?, sem_6=?, sem_7=?, ekz=?, final=? WHERE id=?";
...
if (isset($_POST['delete_submit_mat_401'])) {
    $sql = "DELETE FROM mat401 WHERE id=?";
    $query = $pdo->prepare($sql);
...
<head>
    <meta charset="UTF-8">
    <title>Теоретические основы начального курса математики с методикой преподавания 401 группа</title>
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page__title">Теоретические основы начального курса математики с методикой преподавания 401 группа
                    <br>
