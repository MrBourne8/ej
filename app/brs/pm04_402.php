...
if (isset($_POST['submit'])) {
    $sql = ("INSERT INTO `pm04_402`(`student_name`, `sem_5`, `sem_6`, `sem_7`, `sem_8`, `up`, `pp`, `test`, `otv`, `ekz`, `final`) VALUES(?,?,?,?,?,?,?,?,?,?,?)");
...
// Read
$sql = $pdo->prepare("SELECT * FROM `pm04_402`");
$sql->execute();
...
if (isset($_POST['edit-submit'])) {
    $sqll = "UPDATE pm04_402 SET sem_5=?, sem_6=?, sem_7=?, sem_8=?, up=?, pp=?, test=?, otv=?, ekz=?, final=? WHERE id=?";
...
if (isset($_POST['delete_submit_pm03_341'])) {
    $sql = "DELETE FROM pm04_402 WHERE id=?";
    $query = $pdo->prepare($sql);
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page__title">ПМ02 311 группа
                    <br>
                ...
                <table class="table shadow mehtod_rus_341 table__modules" style="border-collapse: collapse;">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <td>ФИ</td>
                            <td style="width: 100px;">МДК 02.01</td>
                            <td style="width: 100px;">МДК 02.02</td>
                            <td style="width: 100px;">МДК 02.03</td>
                            <td style="width: 100px;">МДК 02.04</td>
                            <td style="width: 100px;">МДК 02.05</td>
                            <td style="width: 100px;">МДК 02.06</td>
                            <td style="width: 100px;">МДК 02.07</td>
                                    ...
                                    <div class="modal-content shadow">
                                        ...
                                        <div class="modal-body">
                                            <form action="?id=<?= $value['id'] ?>" id="?id=<?= $value['id'] ?>" method="post">
                                                ...
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    <p>УП <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
                                                                Отметка за 7 семестр
                                                            </span></a></p>
