...
if (isset($_POST['submit'])) {
    $sql = ("INSERT INTO `pm03_311`(`student_name`, `note_1`, `note_2`, `note_3`, `note_4`, `note_5`, `note_6`, `note_7`, `ekz`, `final`) VALUES(?,?,?,?,?,?,?,?,?,?)");
    $query = $pdo->prepare($sql);
    $query->execute([$students, $sem_3, $sem_4, $sem_5, $sem_6, $sem_7, $sem_8, $sem_9, $ekz, $final]);
...
// Read
$sql = $pdo->prepare("SELECT * FROM `pm03_311`");
$sql->execute();
...
$edit_sem_9 = $_POST['edit_sem_9'];
$edit_ekz = $_POST['edit_ekz'];
$edit_final = $_POST['edit__final__mark__mat__401'];


if (isset($_POST['edit-submit'])) {
    $sqll = "UPDATE pm03_311 SET note_1=?, note_2=?, note_3=?, note_4=?, note_5=?, note_6=?, note_7=?, ekz=?, final=? WHERE id=?";
    $querys = $pdo->prepare($sqll);
    $querys->execute([$edit_sem_3, $edit_sem_4, $edit_sem_5, $edit_sem_6, $edit_sem_7, $edit_sem_8, $edit_sem_9, $edit_ekz, $edit_final, $get_id]);
...
if (isset($_POST['delete_submit_mat_401'])) {
    $sql = "DELETE FROM pm03_311 WHERE id=?";
    $query = $pdo->prepare($sql);
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page__title">ПМ 03 311 группа
                    <br>
                ...
                <table class="table shadow mehtod_mat_401 table__modules" style="border-collapse: collapse;">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <td>ФИ</td>
                            <td style="width: 100px;">МДК 03.01</td>
                            <td style="width: 100px;">МДК 03.02</td>
                            <td style="width: 100px;">МДК 03.03</td>
                            <td style="width: 100px;">МДК 03.04</td>
                            <td style="width: 100px;">МДК 03.05</td>
                            <td style="width: 100px;">УП по ПМ 03</td>
                            <td style="width: 100px;">ПП по ПМ 03</td>
                    ...
                    <tbody>
                        <?php foreach ($result_mat_401 as $value) { ?>
                            <tr>
                                ...
                                <td class="sem_7">
                                    <p class="mark_rus_401"><?= $value['note_7'] ?></p>
                                </td>
                                <td class="ekz">
                                        ...
                                        <div class="modal-body">
                                            <form action="?id=<?= $value['id'] ?>" id="?id=<?= $value['id'] ?>" method="post">
                                                ...
                                                <div class="form-group edit__brs">
                                                    <p>МДК 03.01 <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
                                                                Отметка за МДК 03.01
                                                            </span></a></p>
                                                ...
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    <p>МДК 03.02 <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
                                                                Отметка за МДК 03.02
                                                            </span></a></p>
                                                ...
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    <p>МДК 03.03 <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
                                                                Отметка за МДК 03.03
                                                            </span></a></p>
                                                ...
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    <p>МДК 03.04 <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
                                                                Отметка за МДК 03.04
                                                            </span></a></p>
                                                ...
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    <p>МДК 03.05 <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
                                                                Отметка за МДК 03.05
                                                            </span></a></p>
                                                ...
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    <p>УП по ПМ 03 <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
                                                                Отметка за УП по ПМ 03
                                                            </span></a></p>
                                                    <input class="form-control edit_sem_7_401 edit_note_5 edit__mark__mat__401 edit__notes__lenght" name="edit_sem_8" value="<?= $value['note_6'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 7 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    <p>ПП по ПМ 03 <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
                                                                Отметка за ПП по ПМ 03
                                                            </span></a></p>
                                                    <input class="form-control edit_sem_7_401 edit_note_5 edit__mark__mat__401 edit__notes__lenght" name="edit_sem_9" value="<?= $value['note_7'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 7 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                    ...
                    <div class="modal-body">
                        <form action="" method="post">
                            ...
                            <div class="form-group edit__brs">
                                ...
                                <input class="form-control sem__7__mat__401 semestr__mark" id="average__current_1" name="sem_8" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                            </div>
                            <hr>
                            <div class="form-group edit__brs">
                                ...
                                <input class="form-control sem__7__mat__401 semestr__mark" id="average__current_1" name="sem_9" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                            </div>
                            <hr>
                            <div class="form-group edit__brs">
