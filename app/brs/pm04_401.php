...
$otv = $_POST['otv'];
$ekz = $_POST['ekz'];
$final = $_POST['final__mark__pm04__421'];

$get_id = $_GET['id'];

// Create
if (isset($_POST['submit'])) {
    $sql = ("INSERT INTO `pm04_401`(`student_name`, `sem_5`, `sem_6`, `sem_7`, `sem_8`, `up`, `pp`, `test`, `otv`, `ekz`, `final`) VALUES(?,?,?,?,?,?,?,?,?,?,?)");
    $query = $pdo->prepare($sql);
    $query->execute([$students, $sem_5, $sem_6, $sem_7, $sem_8, $up, $pp, $test, $otv, $ekz, $final]);
...
// Read
$sql = $pdo->prepare("SELECT * FROM `pm04_401`");
$sql->execute();
...
$edit_sem_8 = $_POST['edit_sem_8'];
$edit_up = $_POST['edit_up'];
$edit_pp = $_POST['edit_pp'];
$edit_test = $_POST['edit_test'];
$edit_otv = $_POST['edit_otv'];
$edit_ekz = $_POST['edit_ekz'];
$edit_final = $_POST['edit__final__mark__pm04__401'];


if (isset($_POST['edit-submit'])) {
    $sqll = "UPDATE pm04_401 SET sem_5=?, sem_6=?, sem_7=?, sem_8=?, up=?, pp=?, test=?, otv=?, ekz=?, final=? WHERE id=?";
    $querys = $pdo->prepare($sqll);
    $querys->execute([$edit_sem_5, $edit_sem_6, $edit_sem_7, $edit_sem_8, $edit_up, $edit_pp, $edit_test, $edit_otv, $edit_ekz, $edit_final, $get_id]);
...
if (isset($_POST['delete_submit_pm03_341'])) {
    $sql = "DELETE FROM pm04_401 WHERE id=?";
    $query = $pdo->prepare($sql);
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page__title">МДК01.02 Русский язык с методикой преподавания 401 группа
                    <br>
                ...
                <table class="table shadow mehtod_rus_341 table__modules" style="border-collapse: collapse;">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <td style="width: 100px;">VII</td>
                            <!-- <td style="width: 100px;">ПП</td>
                            <td style="width: 100px;">ТЕСТ</td>
                            <td style="width: 100px;">Ответ на экзамене</td> -->
                    ...
                    <tbody>
                        <?php foreach ($result_rus_341 as $value) { ?>
                            <tr>
                                ...
                                <td class="sem_6">
                                    <p class="mark_rus_341"><?= $value['sem_8'] ?></p>
                                </td>
                                <td class="sem_7">
                                    <p class="mark_rus_341"><?= $value['up'] ?></p>
                                </td>
                                <!-- <td class="sem_7">
                                    <p class="mark_rus_341"><?= $value['pp'] ?></p>
                                </td>
                                <td class="sem_7">
                                    <p class="mark_rus_341"><?= $value['test'] ?></p>
                                </td>
                                <td class="sem_7">
                                    <p class="mark_rus_341"><?= $value['otv'] ?></p>
                                </td> -->
                                <td class="ekz">
                                    <p class="mark_rus_341"><?= $value['ekz'] ?></p>
                                </td>
                                <td>
                                    <p class="final_rus_341 edit__final__mark__pm04__401 final__mark"><?= $value['final'] ?></p>
                                </td>
                                        ...
                                        <div class="modal-body">
                                            <form action="?id=<?= $value['id'] ?>" id="?id=<?= $value['id'] ?>" method="post">
                                                ...
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_sem_5_401 mark__sem__3" name="edit_sem_5" value="<?= $value['sem_5'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 3 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_sem_6_401 edit__mark__pm03__341" name="edit_sem_6" value="<?= $value['sem_6'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 4 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_sem_7_401 edit__mark__pm03__341" name="edit_sem_7" type="number" value="<?= $value['sem_7'] ?>" step="1" placeholder="0" min="2" max="5" title="Отметка за 5 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_sem_8_401 edit__mark__pm03__341" name="edit_sem_8" value="<?= $value['sem_8'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 6 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    <p>VI <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
                                                                Отметка за 7 семестр
                                                            </span></a></p>
                                                    <input class="form-control edit_up_401 edit__mark__pm03__341" name="edit_up" value="<?= $value['up'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 7 семестр">
                                                </div>
                                                <hr>
                                                <!-- <div class="form-group edit__brs">
                                                    <p>ПП <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
                                                                Отметка за 7 семестр
                                                            </span></a></p>
                                                    <input class="form-control edit_pp_401 edit__mark__pm03__341" name="edit_pp" value="<?= $value['pp'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 7 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    <p>ТЕСТ <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
                                                                Отметка за тест
                                                            </span></a></p>
                                                    <input class="form-control edit_test_401 edit__mark__pm03__341" name="edit_test" value="<?= $value['test'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 7 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    <p>Ответ на экзамене <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
                                                                Отметка за 7 семестр
                                                            </span></a></p>
                                                    <input class="form-control edit_otv_401 edit__mark__pm03__341" name="edit_otv" value="<?= $value['otv'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 7 семестр">
                                                </div> -->
                                                <hr>
                                                <div class="form-group edit__brs">
                                                ...
                                                <input type="text" class="edit__final__mark__pm04__401" name="edit__final__mark__pm04__401" value="" hidden>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Отмена</button>
                                                    <button type="submit" name="edit-submit" class="btn btn-primary edit__student__final edit__student__final__401__pm04">Обновить</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-body">
                        <form action="" method="post">
                            ...
                            <div class="form-group edit__brs">
                                ...
                                <input class="form-control sem__5__pm04__401 semestr__mark" id="average__current_1" name="sem_5" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                            ...
                            <div class="form-group edit__brs">
                                ...
                                <input class="form-control sem__6__pm04__401 semestr__mark" id="average__current_1" name="sem_6" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                            </div>
                            <hr>
                            <div class="form-group edit__brs">
                                ...
                                <input class="form-control sem__7__pm04__401 semestr__mark" id="average__current_1" name="sem_7" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                            </div>
                            <hr>
                            <div class="form-group edit__brs">
                                ...
                                <input class="form-control sem__8__pm04__401 semestr__mark" id="average__current_1" name="sem_8" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                            </div>
                            <hr>
                            <div>
                                <div class="form-group edit__brs">
                                    <p>VII <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                            <span class='tip'>
                                                Отметка за 7 семестр
                                            </span></a></p>
                                    <input class="form-control up__pm04__401 semestr__mark" id="average__current_1" name="up" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                    <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                                </div>
                                <hr>
                                <div>
                                    <!-- <div class="form-group edit__brs">
                                        ...
                                        <input class="form-control pp__pm04__401 semestr__mark" id="average__current_1" name="pp" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                        <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                                    </div>
                                    <hr>
                                    <div class="form-group edit__brs">
                                        ...
                                        <input class="form-control test__pm04__401 semestr__mark" id="average__current_1" name="test" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                        <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                                    </div>
                                    <hr>
                                    <div class="form-group edit__brs">
                                        ...
                                        <input class="form-control otv__pm04__401 semestr__mark" id="average__current_1" name="otv" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                        <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                                    </div> -->
                                    <div class="form-group edit__brs">
                                        <p>ЭКЗАМЕН <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                        ...
                                        <input class="form-control exam_401 exam__mark" id="average__current_1" name="ekz" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                        <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                                    </div>
                                    <hr>

                                    <input type="text" class="final__mark__pm04__421 form__final__mark" name="final__mark__pm04__421" value="" hidden>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Отмена</button>
