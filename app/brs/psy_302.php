...
if (isset($_POST['submit'])) {
    $sql = ("INSERT INTO `psy_302`(`student_name`, `note_1`, `note_2`, `note_3`, `note_4`, `note_5`, `ekz`, `final`) VALUES(?,?,?,?,?,?,?,?)");
...
// Read
$sql = $pdo->prepare("SELECT * FROM `psy_302`");
$sql->execute();
...
if (isset($_POST['edit-submit'])) {
    $sqll = "UPDATE psy_302 SET note_1=?, note_2=?, note_3=?, note_4=?, note_5=?, ekz=?, final=? WHERE id=?";
...
if (isset($_POST['delete_submit_mat_401'])) {
    $sql = "DELETE FROM psy_302 WHERE id=?";
    $query = $pdo->prepare($sql);
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page__title">Психология 302 группа
                    <br>
