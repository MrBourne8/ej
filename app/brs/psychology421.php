...
$sem_7 = $_POST['sem_7'];
$ekz = $_POST['ekz'];
$final = $_POST['final__mark__psychology__421'];

$get_id = $_GET['id'];

// Create
if (isset($_POST['submit'])) {
    $sql = ("INSERT INTO `psychology421`(`student_name`, `sem_3`, `sem_4`, `sem_5`, `sem_6`, `sem_7`, `ekz`, `final`) VALUES(?,?,?,?,?,?,?,?)");
...
// Read
$sql = $pdo->prepare("SELECT * FROM `psychology421`");
$sql->execute();
$result_psychology_421 = $sql->fetchAll();
// Read
...
$edit_final = $_POST['edit__final__mark__psychology__421'];


if (isset($_POST['edit-submit'])) {
    $sqll = "UPDATE psychology421 SET sem_3=?, sem_4=?, sem_5=?, sem_6=?, sem_7=?, ekz=?, final=? WHERE id=?";
...
if (isset($_POST['delete_submit'])) {
    $sql = "DELETE FROM psychology421 WHERE id=?";
    $query = $pdo->prepare($sql);
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page__title">Психология 421 группа
                    <br>
                ...
                <table class="table shadow mehtod_psychology_421 table__modules" style="border-collapse: collapse;">
                    ...
                    <tbody>
                        <?php foreach ($result_psychology_421 as $value) { ?>
                            <tr>
                                ...
                                <td class="sem_3 ">
                                    <p class="mark_psychology_421"><?= $value['sem_3'] ?></p>
                                </td>
                                <td class="sem_4 ">
                                    <p class="mark_psychology_421"><?= $value['sem_4'] ?></p>
                                </td>
                                <td class="sem_5">
                                    <p class="mark_psychology_421"><?= $value['sem_5'] ?></p>
                                </td>
                                <td class="sem_6">
                                    <p class="mark_psychology_421"><?= $value['sem_6'] ?></p>
                                </td>
                                <td class="sem_7">
                                    <p class="mark_psychology_421"><?= $value['sem_7'] ?></p>
                                </td>
                                <td class="ekz">
                                    <p class="mark_psychology_421"><?= $value['ekz'] ?></p>
                                </td>
                                <td>
                                    <p class="final_psychology_421 final__mark"><?= $value['final'] ?></p>
                                </td>
                                        ...
                                        <div class="modal-body">
                                            <form action="?id=<?= $value['id'] ?>" id="?id=<?= $value['id'] ?>" method="post">
                                                ...
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_sem_3_421 mark__sem__3" name="edit_sem_3" value="<?= $value['sem_3'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 3 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_sem_4_421 edit__mark__psychology__421" name="edit_sem_4" value="<?= $value['sem_4'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 4 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_sem_5_421 edit__mark__psychology__421" name="edit_sem_5" type="number" value="<?= $value['sem_5'] ?>" step="1" placeholder="0" min="2" max="5" title="Отметка за 5 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_sem_6_421 edit__mark__psychology__421" name="edit_sem_6" value="<?= $value['sem_6'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 6 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_sem_7_421 edit__mark__psychology__421" name="edit_sem_7" value="<?= $value['sem_7'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 7 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_exam_421 edit__mark__psychology__421" name="edit_ekz" value="<?= $value['ekz'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за экзамен">
                                                </div>
                                                <input type="text" class="edit__final__mark__psychology__421" name="edit__final__mark__psychology__421" value="" hidden>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Отмена</button>
                                                    <button type="submit" name="edit-submit" class="btn btn-primary edit__student__final edit__student__final__421">Обновить</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-body">
                        <form action="" method="post">
                            <div class="form-group add__student__brs">
                                <p>Студент:</p>
                                <select class="select__students__final__mark select__psychology" name="student_name" id="add_student_brs331">
                                    <?php foreach ($result_base_421 as $value) { ?>
                            ...
                            <div class="form-group edit__brs">
                                ...
                                <input class="form-control sem__3__psychology__421 semestr__mark" id="average__current_1" name="sem_3" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                            ...
                            <div class="form-group edit__brs">
                                ...
                                <input class="form-control sem__4__psychology__421 semestr__mark" id="average__current_1" name="sem_4" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                            </div>
                            <hr>
                            <div>
                                <div class="form-group edit__brs">
                                    ...
                                    <input class="form-control sem__5__psychology__421 semestr__mark" id="average__current_1" name="sem_5" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                    <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                                </div>
                                <hr>
                                <div>
                                    <div class="form-group edit__brs">
                                        ...
                                        <input class="form-control sem__6__psychology__421 semestr__mark" id="average__current_1" name="sem_6" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                        <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                                    </div>
                                    <hr>
                                    <div class="form-group edit__brs">
                                        ...
                                        <input class="form-control sem__7__psychology__421 semestr__mark" id="average__current_1" name="sem_7" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                        <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                                    </div>
                                    <hr>
                                    <div class="form-group edit__brs">
                                        ...
                                        <input class="form-control ekz__psychology__421 exam__mark" id="average__current_1" name="ekz" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                        <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                                    </div>
                                    <hr>

                                    <input type="text" class="final__mark__psychology__421 form__final__mark" name="final__mark__psychology__421" value="" hidden>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Отмена</button>
