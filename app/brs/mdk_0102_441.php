...
if (isset($_POST['submit'])) {
    $sql = ("INSERT INTO `mdk_0102_441`(`student_name`, `sem_5`, `sem_6`, `sem_7`, `sem_8`, `up`, `pp`, `test`, `otv`, `ekz`, `final`) VALUES(?,?,?,?,?,?,?,?,?,?,?)");
...
// Read
$sql = $pdo->prepare("SELECT * FROM `mdk_0102_441`");
$sql->execute();
...
if (isset($_POST['edit-submit'])) {
    $sqll = "UPDATE mdk_0102_441 SET sem_5=?, sem_6=?, sem_7=?, sem_8=?, up=?, pp=?, test=?, otv=?, ekz=?, final=? WHERE id=?";
...
if (isset($_POST['delete_submit_pm03_341'])) {
    $sql = "DELETE FROM mdk_0102_441 WHERE id=?";
    $query = $pdo->prepare($sql);
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page__title">МДК 01.02 441 группа
                    <br>
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <div class="form-group edit__brs">
                                        <p>ПП <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                <span class='tip'>
                                                    Отметка за ПРОИЗВИДСТВЕННУЮ ПРАКТИКУ
                                                </span></a></p>
