...
if (isset($_POST['submit'])) {
    $sql = ("INSERT INTO `pm03411`(`student_name`, `sem_3`, `sem_4`, `sem_5`, `sem_6`, `ekz`, `final`) VALUES(?,?,?,?,?,?,?)");
    $query = $pdo->prepare($sql);
    $query->execute([$students, $sem_3, $sem_4, $sem_5, $sem_6, $ekz, $final]);
...
if (isset($_POST['edit-submit'])) {
    $sqll = "UPDATE pm03411 SET sem_3=?, sem_4=?, sem_5=?, sem_6=?, ekz=?, final=? WHERE id=?";
    $querys = $pdo->prepare($sqll);
    $querys->execute([$edit_sem_3, $edit_sem_4, $edit_sem_5, $edit_sem_6, $edit_ekz, $edit_final, $get_id]);
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page__title">ПМ 05 411 группа
                    <br>
                ...
                <table class="table shadow mehtod_pm03_411 table__modules" style="border-collapse: collapse;">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <td>ФИ</td>
                            <td style="width: 100px;">VI семестр 2021-2022г</td>
                            <td style="width: 100px;">VII семестр 2022-2023г</td>
                                        ...
                                        <div class="modal-body">
                                            <form action="?id=<?= $value['id'] ?>" id="?id=<?= $value['id'] ?>" method="post">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" name="edit-submit" class="btn btn-primary edit__student__final edit__student__final__411">Обновить</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-body">
                        <form action="" method="post">
                            ...
                            <div>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Отмена</button>
                                    <button type="submit" name="submit" class="btn btn-primary add__student__final add__student__final__411" disabled>Добавить</button>
                                </div>
                            </div>
                        </form>
