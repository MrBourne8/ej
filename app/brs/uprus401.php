...
if (isset($_POST['submit'])) {
    $sql = ("INSERT INTO `up_rus_401`(`student_name`, `sem_3`, `sem_4`, `sem_5`, `sem_6`, `sem_7`, `ekz`, `final`) VALUES(?,?,?,?,?,?,?,?)");
...
// Read
$sql = $pdo->prepare("SELECT * FROM `up_rus_401`");
$sql->execute();
...
if (isset($_POST['edit-submit'])) {
    $sqll = "UPDATE up_rus_401 SET sem_3=?, sem_4=?, sem_5=?, sem_6=?, sem_7=?, ekz=?, final=? WHERE id=?";
...
if (isset($_POST['delete_submit_pm03_341'])) {
    $sql = "DELETE FROM up_rus_401 WHERE id=?";
    $query = $pdo->prepare($sql);
...
<head>
    <meta charset="UTF-8">
    <title>Подготовка педагога дополнительного образования в избранной области деятельности 241 группа</title>
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page__title">УПодготовка педагога дополнительного образования в избранной области деятельности 241 группа
                    <br>
                ...
                <table class="table shadow mehtod_rus_341 table__modules" style="border-collapse: collapse;">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <td style="width: 100px;">Подготовка педагога дополнительного образования в избранной области деятельности (Легоконструирование)</td>
                            <td style="width: 100px;">Подготовка педагога дополнительного образования в избранной области деятельности (Scratch)</td>
                                    ...
                                    <div class="modal-content shadow">
                                        ...
                                        <div class="modal-body">
                                            <form action="?id=<?= $value['id'] ?>" id="?id=<?= $value['id'] ?>" method="post">
                                                ...
                                                <hr> -->
                                                <div class="form-group edit__brs">
                                                    <p>Подготовка педагога дополнительного образования в избранной области деятельности (Легоконструирование) <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
                                                ...
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    <p>Подготовка педагога дополнительного образования в избранной области деятельности (Scratch) <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
