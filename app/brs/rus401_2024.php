...
if (isset($_POST['submit'])) {
    $sql = ("INSERT INTO `pm04_401`(`student_name`, `sem_3`, `sem_4`, `sem_5`, `sem_6`, `sem_7`, `ekz`, `final`) VALUES(?,?,?,?,?,?,?,?)");
...
if (isset($_POST['edit-submit'])) {
    $sqll = "UPDATE pm04_401 SET sem_3=?, sem_4=?, sem_5=?, sem_6=?, sem_7=?, ekz=?, final=? WHERE id=?";
...
<head>
    <meta charset="UTF-8">
    <title>Русский язык с методикой преподавания 401</title>
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page__title">Русский язык с методикой преподавания 401 группа
                    <br>
