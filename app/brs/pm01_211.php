...
if (isset($_POST['submit'])) {
    $sql = ("INSERT INTO `pm01_211`(`student_name`, `note_1`, `note_2`, `note_3`, `note_4`, `note_5`, `note_6`,  `ekz`, `final`) VALUES(?,?,?,?,?,?,?,?,?)");
    $query = $pdo->prepare($sql);
    $query->execute([$students, $sem_1, $sem_2, $sem_3, $sem_4, $sem_5, $sem_6, $ekz, $final]);
...
// Read
$sql = $pdo->prepare("SELECT * FROM `pm01_211`");
$sql->execute();
...
// Update
$edit_sem_1 = $_POST['edit_sem_1'];
$edit_sem_2 = $_POST['edit_sem_2'];
...
if (isset($_POST['edit-submit'])) {
    $sqll = "UPDATE pm01_211 SET note_1=?, note_2=?, note_3=?, note_4=?, note_5=?, note_6=?, ekz=?, final=? WHERE id=?";
    $querys = $pdo->prepare($sqll);
    $querys->execute([$edit_sem_1, $edit_sem_2, $edit_sem_3, $edit_sem_4, $edit_sem_5, $edit_sem_6, $edit_ekz, $edit_final, $get_id]);
...
if (isset($_POST['delete_submit_mat_401'])) {
    $sql = "DELETE FROM pm01_211 WHERE id=?";
    $query = $pdo->prepare($sql);
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page__title">ПМ 01 211 группа
                    <br>
                ...
                <table class="table shadow mehtod_mat_401 table__modules" style="border-collapse: collapse;">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <td>ФИ</td>
                            <td style="width: 100px;">МДК 01.01</td>
                            <td style="width: 100px;">МДК 01.02</td>
                            <td style="width: 100px;">МДК 01.03</td>
                            <td style="width: 100px;">УП по ПМ 01</td>
                            <td style="width: 100px;">ПП по ПМ 01</td>
                    ...
                    <tbody>
                        <?php foreach ($result_mat_401 as $value) { ?>
                            <tr>
                                ...
                                <!-- <td class="sem_6">
                                    <p class="mark_rus_401"><?= $value['note_6'] ?></p>
                                </td> -->
                                <td class="ekz">
                                        ...
                                        <div class="modal-body">
                                            <form action="?id=<?= $value['id'] ?>" id="?id=<?= $value['id'] ?>" method="post">
                                                ...
                                                <div class="form-group edit__brs">
                                                    <p>МДК 01.01 <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
                                                                Отметка за 3 семестр
                                                            </span></a></p>
                                                    <input class="form-control edit_sem_3_401 edit_note_1 mark__mat__401 edit__notes__lenght" name="edit_sem_1" value="<?= $value['note_1'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 3 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    <p>МДК 01.02 <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
                                                                Отметка за 1 семестр
                                                            </span></a></p>
                                                    <input class="form-control edit_sem_4_401 edit_note_2 edit__mark__mat__401 edit__notes__lenght" name="edit_sem_2" value="<?= $value['note_2'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 4 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    <p>МДК 01.03 <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
                                                                Отметка за 2 семестр
                                                            </span></a></p>
                                                    <input class="form-control edit_sem_5_401 edit_note_3 edit__mark__mat__401 edit__notes__lenght" name="edit_sem_3" type="number" value="<?= $value['note_3'] ?>" step="1" placeholder="0" min="2" max="5" title="Отметка за 5 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    <p>УП по ПМ 01 <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
                                                                Отметка за 3 семестр
                                                            </span></a></p>
                                                    <input class="form-control edit_sem_6_401 edit_note_4 edit__mark__mat__401 edit__notes__lenght" name="edit_sem_4" value="<?= $value['note_4'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 6 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    <p>ПП по ПМ 01 <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
                                                                Отметка за экзамен
                                                            </span></a></p>
                                                    <input class="form-control edit_sem_7_401 edit_note_5 edit__mark__mat__401 edit__notes__lenght" name="edit_sem_5" value="<?= $value['note_5'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 7 семестр">
                                                </div>
                                                <hr>
                                                <!-- <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_sem_7_401 edit_note_5 edit__mark__mat__401 edit__notes__lenght" name="edit_sem_6" value="<?= $value['note_6'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 7 семестр">
                                                </div>
                                                <hr> -->
                                                <div class="form-group edit__brs">
                    ...
                    <div class="modal-body">
                        <form action="" method="post">
                            <div class="form-group add__student__brs">
                                ...
                                <select class="select__students__final__mark select__mat" name="student_name" id="add_student_brs331">
                                    <?php foreach ($result_base_401 as $value) { ?>
                                        <option value="0" select="selected" hidden>Выберите студента</option>
                            ...
                            <div class="form-group edit__brs">
                                ...
                                <input class="form-control sem__3__mat__401 semestr__mark" id="average__current_1" name="sem_1" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                            ...
                            <div class="form-group edit__brs">
                                ...
                                <input class="form-control sem__4__mat__401 semestr__mark" id="average__current_1" name="sem_2" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                            </div>
                            <hr>
                            <div class="form-group edit__brs">
                                ...
                                <input class="form-control sem__5__mat__401 semestr__mark" id="average__current_1" name="sem_3" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                            </div>
                            <hr>
                            <div class="form-group edit__brs">
                                ...
                                <input class="form-control sem__6__mat__401 semestr__mark" id="average__current_1" name="sem_4" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                            </div>
                            <hr>
                            <div class="form-group edit__brs">
                                ...
                                <input class="form-control sem__7__mat__401 semestr__mark" id="average__current_1" name="sem_5" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                            </div>
                            <hr>
                            <!-- <div class="form-group edit__brs">
                                ...
                                <input class="form-control sem__7__mat__401 semestr__mark" id="average__current_1" name="sem_6" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                            </div>
                            <hr> -->
                            <div class="form-group edit__brs">
