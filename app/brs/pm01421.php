...
$sem_7 = $_POST['sem_7'];
$ekz = $_POST['ekz'];
$final = $_POST['final__mark__pm01__421'];

$get_id = $_GET['id'];

// Create
if (isset($_POST['submit'])) {
    $sql = ("INSERT INTO `pm01421`(`student_name`, `sem_3`, `sem_4`, `sem_5`, `sem_6`, `sem_7`, `ekz`, `final`) VALUES(?,?,?,?,?,?,?,?)");
...
// Read
$sql = $pdo->prepare("SELECT * FROM `pm01421`");
$sql->execute();
$result_rus_421 = $sql->fetchAll();
// Read
...
$edit_final = $_POST['edit__final__mark__pm01__421'];


if (isset($_POST['edit-submit'])) {
    $sqll = "UPDATE pm01421 SET sem_3=?, sem_4=?, sem_5=?, sem_6=?, sem_7=?, ekz=?, final=? WHERE id=?";
...
// DELETE
if (isset($_POST['delete_submit__pm01__421'])) {
    $sql = "DELETE FROM pm01421 WHERE id=?";
    $query = $pdo->prepare($sql);
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page__title">ПМ 01 421 группа
                    <br>
                ...
                <table class="table shadow mehtod_rus_421 table__modules" style="border-collapse: collapse;">
                    ...
                    <tbody>
                        <?php foreach ($result_rus_421 as $value) { ?>
                            <tr>
                                ...
                                <td class="sem_3 ">
                                    <p class="mark_pm01_421"><?= $value['sem_3'] ?></p>
                                </td>
                                <td class="sem_4 ">
                                    <p class="mark_pm01_421"><?= $value['sem_4'] ?></p>
                                </td>
                                <td class="sem_5 ">
                                    <p class="mark_pm01_421"><?= $value['sem_5'] ?></p>
                                </td>
                                <td class="ekz">
                                    <p class="mark_pm01_421"><?= $value['ekz'] ?></p>
                                </td>
                                <td>
                                    <p class="final_pm01_421 final__mark"><?= $value['final'] ?></p>
                                </td>
                                        ...
                                        <div class="modal-body">
                                            <form action="?id=<?= $value['id'] ?>" id="?id=<?= $value['id'] ?>" method="post">
                                                ...
                                                <div class="form-group edit__brs">
                                                    ...
                                                    <input class="form-control edit_sem_4_421 edit__mark__pm01__421" name="edit_sem_4" value="<?= $value['sem_4'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 4 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    <p>МДК 01 <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
                                                                Отметка за 4 семестр
                                                            </span></a></p>
                                                    <input class="form-control edit_sem_5_421 edit__mark__pm01__421" name="edit_sem_5" value="<?= $value['sem_5'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за 4 семестр">
                                                </div>
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    <p>ДЭМОЭКЗАМЕН <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
                                                                Отметка за экзамен
                                                            </span></a></p>
                                                    <input class="form-control edit_exam_421 edit__mark__pm01__421" name="edit_ekz" value="<?= $value['ekz'] ?>" type="number" step="1" placeholder="0" min="2" max="5" title="Отметка за экзамен">
                                                </div>
                                                <input type="text" class="edit__final__mark__pm01__421" name="edit__final__mark__pm01__421" value="" hidden>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Отмена</button>
                                                    <button type="submit" name="edit-submit" class="btn btn-primary edit__student__final edit__student__final__421__pm01">Обновить</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-content shadow">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="?id=<?= $value['id'] ?>" method="post">
                                                <button type="submit" name="delete_submit__pm01__421" class="btn btn-danger brs__delete">Удалить</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal-body">
                        <form action="" method="post">
                            ...
                            <div class="form-group edit__brs">
                                ...
                                <input class="form-control sem__3__pm01__421 semestr__mark" id="average__current_1" name="sem_3" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                            ...
                            <div class="form-group edit__brs">
                                ...
                                <input class="form-control sem__4__pm01__421 semestr__mark" id="average__current_1" name="sem_4" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                            </div>
                            <div class="form-group edit__brs">
                                ...
                                <input class="form-control sem__5__pm01__421 semestr__mark" id="average__current_1" name="sem_5" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                                <input type="text" class="summ__average__current_1" id="summ__average__current_1" value="0" hidden>
                            </div>
                            <hr>
                            <div class="form-group edit__brs">
                                ...
                                <input class="form-control ekz__pm01__421 exam__mark" id="average__current_1" name="ekz" value="2" type="number" step="1" placeholder="0" min="2" max="5" title="Результат КН">
                            </div>
                            <hr>

                            <input type="text" class="final__mark__pm01__421 form__final__mark" name="final__mark__pm01__421" value="" hidden>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Отмена</button>
