...
if (isset($_POST['submit'])) {
    $sql = ("INSERT INTO `mdk01_301`(`student_name`, `note_1`, `note_2`, `note_3`, `note_4`, `note_5`, `ekz`, `final`) VALUES(?,?,?,?,?,?,?,?)");
...
// Read
$sql = $pdo->prepare("SELECT * FROM `mdk01_301`");
$sql->execute();
...
if (isset($_POST['edit-submit'])) {
    $sqll = "UPDATE mdk01_301 SET note_1=?, note_2=?, note_3=?, note_4=?, note_5=?, ekz=?, final=? WHERE id=?";
...
if (isset($_POST['delete_submit_mat_401'])) {
    $sql = "DELETE FROM mdk01_301 WHERE id=?";
    $query = $pdo->prepare($sql);
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page__title">МДК 01.05 Естествознание с методикой преподавания 301 группа
                    <br>
                ...
                <table class="table shadow mehtod_mat_401 table__modules" style="border-collapse: collapse;">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <td>ФИ</td>
                            <td style="width: 100px;">I семестр</td>
                            <td style="width: 100px;">II семестр</td>
                                        ...
                                        <div class="modal-body">
                                            <form action="?id=<?= $value['id'] ?>" id="?id=<?= $value['id'] ?>" method="post">
                                                ...
                                                <div class="form-group edit__brs">
                                                    <p>I СЕМЕСТР <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
                                                ...
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    <p>II СЕМЕСТР <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
