...
if (isset($_POST['submit'])) {
    $sql = ("INSERT INTO `pdo_341`(`student_name`, `note_1`, `note_2`, `note_3`, `note_4`, `note_5`, `note_6`,  `ekz`, `final`) VALUES(?,?,?,?,?,?,?,?,?)");
...
// Read
$sql = $pdo->prepare("SELECT * FROM `pdo_341`");
$sql->execute();
...
if (isset($_POST['edit-submit'])) {
    $sqll = "UPDATE pdo_341 SET note_1=?, note_2=?, note_3=?, note_4=?, note_5=?, note_6=?, ekz=?, final=? WHERE id=?";
...
if (isset($_POST['delete_submit_mat_401'])) {
    $sql = "DELETE FROM pdo_341 WHERE id=?";
    $query = $pdo->prepare($sql);
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page__title">Подготовка педагога ДО в избранной области деятельности 341 группа
                    <br>
                ...
                <table class="table shadow mehtod_mat_401 table__modules" style="border-collapse: collapse;">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <td>ФИ</td>
                            <td style="width: 100px;">ВЕБ - дизайн</td>
                            <td style="width: 100px;">Графический дизайн</td>
                                        ...
                                        <div class="modal-body">
                                            <form action="?id=<?= $value['id'] ?>" id="?id=<?= $value['id'] ?>" method="post">
                                                ...
                                                <div class="form-group edit__brs">
                                                    <p>ВЕБ - дизайн <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
                                                ...
                                                <hr>
                                                <div class="form-group edit__brs">
                                                    <p>Графический дизайн <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
                                                ...
                                                <hr>
                                                <!-- <div class="form-group edit__brs">
                                                    <p>3Д моделирование <a class="support" tabindex="1" href="#"><i class="far fa-question-circle"></i>
                                                            <span class='tip'>
